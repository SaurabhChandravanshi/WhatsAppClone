...
export default function ConversationHeader({title}) {
  ...
  return (
    ...
    <header className="chatHeader">
      ...
      <svg onClick={() => closeConversation()} viewBox="0 0 24 24" width="24" height="24" class=""><path fill="#54656f" d="m19.8 5.8-1.6-1.6-6.2 6.2-6.2-6.2-1.6 1.6 6.2 6.2-6.2 6.2 1.6 1.6 6.2-6.2 6.2 6.2 1.6-1.6-6.2-6.2 6.2-6.2z"></path></svg>
      </div>
      </div>
      </div>
    </header>
